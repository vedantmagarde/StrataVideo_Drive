...
const FeatureCard = ({ icon: Icon, title, description }) => (
    <div className="flex flex-col items-start p-6 bg-white/60 backdrop-blur-md rounded-2xl border border-slate-200/60 hover:border-indigo-300 hover:bg-white transition-all duration-300 shadow-sm hover:shadow-md">
            ...
            <nav className="relative z-10 flex items-center justify-between px-8 py-6 w-full max-w-7xl mx-auto">
                <div className="flex items-center space-x-3">
                    <div className="p-2 bg-indigo-50 rounded-xl border border-indigo-100">
                        <StrataVideoIcon className="w-8 h-8 text-indigo-600" />
                    </div>
                    <span className="text-2xl font-bold text-slate-900 tracking-tight">StrataVideo<span className="text-indigo-600">Drive</span></span>
                </div>
                <div className="flex items-center gap-4">
                    <a href="https://github.com/vedantmagarde/StrataVideo_Drive" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-slate-900 transition-colors text-sm font-medium">
                        GitHub
                    </a>
                </div>
            </nav>
